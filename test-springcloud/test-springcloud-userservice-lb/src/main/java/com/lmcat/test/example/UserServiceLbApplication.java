...
public class UserServiceLbApplication {
     ...
     * logger instance
     */
    static Logger logger = LoggerFactory.getLogger(UserServiceLbApplication.class);
    ...
    public String index() {
        System.out.println("index(---port=9091).....lb");
        return "this is user index---port=9091.....lb";
    }
}
